...
const blogs = [
    {
        title: "Top marketing hacks towards success in your business!",
    ...
    {
        title: "Best Practices for Google Shopping Feed Optimization",
    ...
    {
        title: "Top 6 ways to boost your website conversion with SEO",
